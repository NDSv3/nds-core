#ifndef DEVICEVECTORFLOAT_H_
#define DEVICEVECTORFLOAT_H_
...
public:
     ...
     */
    DeviceVectorFloat(nds::Factory& factory, const std::string& deviceName, const nds::namedParameters_t& );
    ~DeviceVectorFloat();
     ...
     *  the device
     */
    static DeviceVectorFloat* getInstance(const std::string& deviceName);
...
private:
    ...
    /**
     * @brief DeviceVectorFloat state machine
     */
    nds::StateMachine m_DeviceVectorFloat_stateMachine;

    /**
     * Methods to control DeviceVectorFloat state machine
     */
    void switchOn_DeviceVectorFloat();  ///< Called to switch on the DeviceVectorFloat (rootnode).
    void switchOff_DeviceVectorFloat(); ///< Called to switch off the DeviceVectorFloat (rootnode).
    void start_DeviceVectorFloat();     ///< Called to start the DeviceVectorFloat (rootnode).
    void stop_DeviceVectorFloat();      ///< Called to stop the DeviceVectorFloat (rootnode).
    void recover_DeviceVectorFloat();   ///< Called to recover the DeviceVectorFloat (rootnode) from a failure.

    bool allow_DeviceVectorFloat_Change(const nds::state_t, const nds::state_t, const nds::state_t); ///< Called to verify if a state change is allowed
     ...
     */
    nds::DataAcquisition<std::vector<float> > m_DataAcquisition;
     ...
     */
    nds::WaveformGeneration<std::vector<float>> m_WaveformGeneration;
