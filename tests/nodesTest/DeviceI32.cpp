...
static std::map<std::string, DeviceI32*> m_devicesMap;
static std::mutex m_lockDevicesMap;

DeviceI32::DeviceI32(nds::Factory &factory, const std::string &deviceName, const nds::namedParameters_t & parameters):
    m_name(deviceName), timestamp_device{0,0},readtimeStamp{0,0}
{
    ...
    if (findParam != parameters.end() && findParam->second=="YES") {
        ...
        nds::DataAcquisitionArgs_t handlerDAQ = nds::DataAcquisitionArgs_t (
                std::bind(&DeviceI32::switchOn_DataAcquisition, this),
                std::bind(&DeviceI32::switchOff_DataAcquisition, this),
                std::bind(&DeviceI32::start_DataAcquisition, this),
                std::bind(&DeviceI32::stop_DataAcquisition, this),
                std::bind(&DeviceI32::recover_DataAcquisition, this),
                std::bind(&DeviceI32::allow_DataAcquisition_Change, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3),
                std::bind(&DeviceI32::PV_DataAcquisition_Gain_Writer,this, std::placeholders::_1, std::placeholders::_2),
                std::bind(&DeviceI32::PV_DataAcquisition_Offset_Writer,this, std::placeholders::_1, std::placeholders::_2),
                std::bind(&DeviceI32::PV_DataAcquisition_Bandwidth_Writer,this, std::placeholders::_1, std::placeholders::_2),
                std::bind(&DeviceI32::PV_DataAcquisition_Resolution_Writer,this, std::placeholders::_1, std::placeholders::_2),
        ...
        handlerDAQ.PV_Gain_Initializer = std::bind(&DeviceI32::PV_DataAcquisition_Gain_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerDAQ.PV_Offset_Initializer = std::bind(&DeviceI32::PV_DataAcquisition_Offset_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerDAQ.PV_Bandwidth_Initializer = std::bind(&DeviceI32::PV_DataAcquisition_Bandwidth_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerDAQ.PV_Resolution_Initializer = std::bind(&DeviceI32::PV_DataAcquisition_Resolution_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerDAQ.PV_Impedance_Initializer = std::bind(&DeviceI32::PV_DataAcquisition_Impedance_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerDAQ.PV_Coupling_Initializer = std::bind(&DeviceI32::PV_DataAcquisition_Coupling_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerDAQ.PV_SignalRefType_Initializer = std::bind(&DeviceI32::PV_DataAcquisition_SignalRefType_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerDAQ.PV_Ground_Initializer = std::bind(&DeviceI32::PV_DataAcquisition_Ground_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerDAQ.PV_DMAEnable_Initializer = std::bind(&DeviceI32::PV_DataAcquisition_DMAEnable_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerDAQ.PV_SamplingRate_Initializer = std::bind(&DeviceI32::PV_DataAcquisition_SamplingRate_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        //Set init values
        handlerDAQ.m_Decimation_Init = 1;
        handlerDAQ.m_DecimationType_Init = 2;
        m_DataAcquisition = rootNode.addChild(nds::DataAcquisition<std::int32_t>(
                        "DataAcquisitionNode",
                        1,
                        handlerDAQ));
    } else {
    ...
    if (findParam != parameters.end() && findParam->second=="YES") {
         //Set compulsory methods
        nds::WaveformGenerationArgs_t<std::int32_t> handlerWFG = nds::WaveformGenerationArgs_t<std::int32_t>(
                std::bind(&DeviceI32::switchOn_WaveformGeneration, this),
                std::bind(&DeviceI32::switchOff_WaveformGeneration, this),
                std::bind(&DeviceI32::start_WaveformGeneration, this),
                std::bind(&DeviceI32::stop_WaveformGeneration, this),
                std::bind(&DeviceI32::recover_WaveformGeneration, this),
                std::bind(&DeviceI32::allow_WaveformGeneration_Change, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3),
                std::bind(&DeviceI32::PV_WaveformGeneration_Frequency_Writer,this, std::placeholders::_1, std::placeholders::_2),
                std::bind(&DeviceI32::PV_WaveformGeneration_RefFrequency_Writer,this, std::placeholders::_1, std::placeholders::_2),
                std::bind(&DeviceI32::PV_WaveformGeneration_Amp_Writer,this, std::placeholders::_1, std::placeholders::_2),
                std::bind(&DeviceI32::PV_WaveformGeneration_Phase_Writer,this, std::placeholders::_1, std::placeholders::_2),
                std::bind(&DeviceI32::PV_WaveformGeneration_UpdateRate_Writer,this,  std::placeholders::_1, std::placeholders::_2),
                std::bind(&DeviceI32::PV_WaveformGeneration_DutyCycle_Writer,this,  std::placeholders::_1, std::placeholders::_2),
                std::bind(&DeviceI32::PV_WaveformGeneration_Gain_Writer,this, std::placeholders::_1, std::placeholders::_2),
                std::bind(&DeviceI32::PV_WaveformGeneration_Offset_Writer,this, std::placeholders::_1, std::placeholders::_2),
                std::bind(&DeviceI32::PV_WaveformGeneration_Bandwidth_Writer,this, std::placeholders::_1, std::placeholders::_2),
                std::bind(&DeviceI32::PV_WaveformGeneration_Resolution_Writer,this, std::placeholders::_1, std::placeholders::_2),
                std::bind(&DeviceI32::PV_WaveformGeneration_Impedance_Writer,this,  std::placeholders::_1, std::placeholders::_2),
                std::bind(&DeviceI32::PV_WaveformGeneration_Coupling_Writer,this,   std::placeholders::_1, std::placeholders::_2),
                std::bind(&DeviceI32::PV_WaveformGeneration_SignalRef_Writer,this,  std::placeholders::_1, std::placeholders::_2),
                std::bind(&DeviceI32::PV_WaveformGeneration_SignalType_Writer,this,  std::placeholders::_1, std::placeholders::_2),
                std::bind(&DeviceI32::PV_WaveformGeneration_Ground_Writer,this, std::placeholders::_1, std::placeholders::_2));
        //Set optional methods
        handlerWFG.PV_Frequency_Initializer = std::bind(&DeviceI32::PV_WaveformGeneration_Frequency_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerWFG.PV_RefFrequency_Initializer = std::bind(&DeviceI32::PV_WaveformGeneration_RefFrequency_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerWFG.PV_Amp_Initializer = std::bind(&DeviceI32::PV_WaveformGeneration_Amp_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerWFG.PV_Phase_Initializer = std::bind(&DeviceI32::PV_WaveformGeneration_Phase_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerWFG.PV_UpdateRate_Initializer = std::bind(&DeviceI32::PV_WaveformGeneration_UpdateRate_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerWFG.PV_DutyCycle_Initializer = std::bind(&DeviceI32::PV_WaveformGeneration_DutyCycle_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerWFG.PV_Gain_Initializer = std::bind(&DeviceI32::PV_WaveformGeneration_Gain_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerWFG.PV_Offset_Initializer = std::bind(&DeviceI32::PV_WaveformGeneration_Offset_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerWFG.PV_Bandwidth_Initializer = std::bind(&DeviceI32::PV_WaveformGeneration_Bandwidth_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerWFG.PV_Resolution_Initializer = std::bind(&DeviceI32::PV_WaveformGeneration_Resolution_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerWFG.PV_Impedance_Initializer = std::bind(&DeviceI32::PV_WaveformGeneration_Impedance_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerWFG.PV_Coupling_Initializer = std::bind(&DeviceI32::PV_WaveformGeneration_Coupling_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerWFG.PV_SignalRef_Initializer = std::bind(&DeviceI32::PV_WaveformGeneration_SignalRef_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerWFG.PV_SignalType_Initializer = std::bind(&DeviceI32::PV_WaveformGeneration_SignalType_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        handlerWFG.PV_Ground_Initializer = std::bind(&DeviceI32::PV_WaveformGeneration_Ground_Initializer, this, std::placeholders::_1, std::placeholders::_2);
        //Set init values
        handlerWFG.m_Decimation_Init = 1;
        handlerWFG.m_DataAWG_Init = -5;
        //Add the WFG node
        m_WaveformGeneration = rootNode.addChild(nds::WaveformGeneration<std::int32_t>("WFGNode",1,handlerWFG));
    } else {
        m_WaveformGeneration = rootNode.addChild(nds::WaveformGeneration<std::int32_t>(
                "WFGNode",
                1,
                std::bind(&DeviceI32::switchOn_WaveformGeneration, this),
                std::bind(&DeviceI32::switchOff_WaveformGeneration, this),
    ...
    rootNode.setTimestampDelegate(std::bind(&DeviceI32::getCurrentTime,this));
}
...
DeviceI32* DeviceI32::getInstance(const std::string& deviceName)
{
    std::lock_guard<std::mutex> lock(m_lockDevicesMap);

    std::map<std::string, DeviceI32*>::const_iterator findDevice = m_devicesMap.find(deviceName);
...
timespec DeviceI32::getCurrentTime()
{
    timespec time;
...
void DeviceI32::stop_DataAcquisition(){
...
void DeviceI32::recover_DataAcquisition(){
...
bool DeviceI32::allow_DataAcquisition_Change(const nds::state_t, const nds::state_t, const nds::state_t){
    return true;
}
...
void DeviceI32::PV_DataAcquisition_Offset_Writer(const timespec& timestamp, const double& value){
    double HW_value;
...
void DeviceI32::PV_DataAcquisition_Bandwidth_Writer(const timespec& timestamp, const double& value){
    double HW_value;
...
void DeviceI32::PV_DataAcquisition_Resolution_Writer(const timespec& timestamp, const double& value){
    double HW_value;
...
void DeviceI32::PV_DataAcquisition_Impedance_Writer(const timespec& timestamp, const double& value){
    double HW_value;
...
void DeviceI32::PV_DataAcquisition_Coupling_Writer(const timespec& timestamp, const std::int32_t& value){
...
void DeviceI32::PV_DataAcquisition_SignalRefType_Writer(const timespec& timestamp, const std::int32_t& value){
    std::int32_t HW_value;
...
void DeviceI32::PV_DataAcquisition_Ground_Writer(const timespec& timestamp, const std::int32_t& value){
    std::int32_t HW_value;
...
void DeviceI32::PV_DataAcquisition_DMAEnable_Writer(const timespec& timestamp,  const std::int32_t& value) {
    std::int32_t HW_value;
...
void DeviceI32::PV_DataAcquisition_Gain_Initializer(timespec* timestamp,
        double* value) {
    *timestamp = {NDS_EPOCH, 10};
    *value = 2.5; //Note that this value has no sense and it is fixed only for testing purposes.
}

void DeviceI32::PV_DataAcquisition_Offset_Initializer(timespec* timestamp,
        double* value) {
    *timestamp = {NDS_EPOCH, 20};
    *value = 3.0; //Note that this value has no sense and it is fixed only for testing purposes.
}

void DeviceI32::PV_DataAcquisition_Bandwidth_Initializer(timespec* timestamp,
        double* value) {
...
void DeviceI32::PV_DataAcquisition_Ground_Initializer(timespec* timestamp,
        int32_t* value) {
    *timestamp = {NDS_EPOCH, 80};
    *value = 0; //Note that this value has no sense and it is fixed only for testing purposes.
}

void DeviceI32::PV_DataAcquisition_DMAEnable_Initializer(timespec* timestamp,
        int32_t* value) {
    *timestamp = {NDS_EPOCH, 90};
    *value = 0; //Note that this value has no sense and it is fixed only for testing purposes.
}

void DeviceI32::PV_DataAcquisition_SamplingRate_Initializer(timespec* timestamp,
        double* value) {
...
void DeviceI32::switchOn_WaveformGeneration(){

}

void DeviceI32::switchOff_WaveformGeneration(){

}

void DeviceI32::start_WaveformGeneration(){
...
void DeviceI32::recover_WaveformGeneration(){
    throw nds::StateMachineRollBack("Cannot recover"); //TODO: Study this
}

bool DeviceI32::allow_WaveformGeneration_Change(const nds::state_t, const nds::state_t, const nds::state_t){
    return true;
}
...
*/
void DeviceI32::PV_WaveformGeneration_Frequency_Writer(const timespec& timestamp, const double& value){
    double HW_value;
...
void DeviceI32::PV_WaveformGeneration_RefFrequency_Writer(const timespec& timestamp, const double& value){
    double HW_value;
...
void DeviceI32::PV_WaveformGeneration_Amp_Writer(const timespec& timestamp, const double& value){
    double HW_value;
...
void DeviceI32::PV_WaveformGeneration_Phase_Writer(const timespec& timestamp, const double& value){
    double HW_value;
...
void DeviceI32::PV_WaveformGeneration_UpdateRate_Writer(const timespec& timestamp, const double& value){
    double HW_value;
...
void DeviceI32::PV_WaveformGeneration_DutyCycle_Writer(const timespec& timestamp, const double& value){
    double HW_value;
...
void DeviceI32::PV_WaveformGeneration_Gain_Writer(const timespec& timestamp, const double& value){
    double HW_value;
    //Value has the Gain to be programmed on the hardware.
    //Call to function programming the hardware. This function should return the real Gain programmed. This value has to be set to the readback attribute.
    //In the meantime, without real hardware value and  HW_value are equal.
...
void DeviceI32::PV_WaveformGeneration_Offset_Writer(const timespec& timestamp, const double& value){
    double HW_value;
    //Value has the Offset to be programmed on the hardware.
    //Call to function programming the hardware. This function should return the real Offset programmed. This value has to be set to the readback attribute.
    //In the meantime, without real hardware value and  HW_value are equal.
...
void DeviceI32::PV_WaveformGeneration_Bandwidth_Writer(const timespec& timestamp, const double& value){
    double HW_value;
    //Value has the Bandwidth to be programmed on the hardware.
    //Call to function programming the hardware. This function should return the real Bandwidth programmed. This value has to be set to the readback attribute.
    //In the meantime, without real hardware value and  HW_value are equal.
...
void DeviceI32::PV_WaveformGeneration_Resolution_Writer(const timespec& timestamp, const double& value){
    double HW_value;
    //Value has the Resolution to be programmed on the hardware.
    //Call to function programming the hardware. This function should return the real Resolution programmed. This value has to be set to the readback attribute.
    //In the meantime, without real hardware value and  HW_value are equal.
...
void DeviceI32::PV_WaveformGeneration_Impedance_Writer(const timespec& timestamp, const std::int32_t& value){
    std::int32_t HW_value;
    //Value has the Impedance to be programmed on the hardware.
    //Call to function programming the hardware. This function should return the real Impedance programmed. This value has to be set to the readback attribute.
    //In the meantime, without real hardware value and  HW_value are equal.
...
void DeviceI32::PV_WaveformGeneration_Coupling_Writer(const timespec& timestamp, const std::int32_t& value){
    std::int32_t HW_value;
    //Value has the Coupling to be programmed on the hardware.
    //Call to function programming the hardware. This function should return the real Coupling programmed. This value has to be set to the readback attribute.
    //In the meantime, without real hardware value and  HW_value are equal.
...
void DeviceI32::PV_WaveformGeneration_SignalRef_Writer(const timespec& timestamp, const std::int32_t& value){
    std::int32_t HW_value;
...
void DeviceI32::PV_WaveformGeneration_SignalType_Writer(const timespec& timestamp, const std::int32_t& value){
    std::int32_t HW_value;
...
void DeviceI32::PV_WaveformGeneration_Ground_Writer(const timespec& timestamp, const std::int32_t& value){
    std::int32_t HW_value;
    //value has the Ground to be programmed on the hardware
    //call to function programming the hardware. This function should return the real Ground programmed. This value has to be set to the readback attribute.
    //in the meantime without real hardware value and  HW_value are equal.
...
void DeviceI32::PV_WaveformGeneration_Frequency_Initializer(timespec* timestamp,
        double* value) {
    *timestamp = {NDS_EPOCH, 110};
    *value = 2.5e6; //Note that this value has no sense and it is fixed only for testing purposes.
}

void DeviceI32::PV_WaveformGeneration_RefFrequency_Initializer(
...
*/
void DeviceI32::WaveformGeneration_thread_body(){
 ...
 * Allocation function
 *********************/
void* DeviceI32::allocateDevice(nds::Factory& factory, const std::string& deviceName, const nds::namedParameters_t& parameters)
{
    return new DeviceI32(factory, deviceName, parameters);
}
