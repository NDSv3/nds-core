...
void DeviceVectorFloat::switchOn_DataAcquisition(){
    ...
    m_DataAcquisition.setDMABufferSize(m_DataAcquisition.getTimestamp(),(std::int32_t)4194304);
    // Call API HW to retrieve DMAEnable -> (ex: DMAEnable initial status OFF (0))
    m_DataAcquisition.setDMAEnable(m_DataAcquisition.getTimestamp(),(std::int32_t)0);
    // Call API HW to retrieve DMAFrameType -> (ex: DMAFrameType=0)
    m_DataAcquisition.setDMAFrameType(m_DataAcquisition.getTimestamp(),(std::int32_t)1);
    // Call API HW to retrieve DMANumChannels -> (ex: DMANumChannels=4)
    m_DataAcquisition.setDMANumChannels(m_DataAcquisition.getTimestamp(),(std::int32_t)4);
    // Call API HW to retrieve DMASampleSize -> (ex: DMASampleSize=49
    m_DataAcquisition.setDMASampleSize(m_DataAcquisition.getTimestamp(),(std::int32_t)4);
    // Call API HW to retrieve SamplingRate -> (ex: SamplingRate=1000)
    m_DataAcquisition.setSamplingRate(m_DataAcquisition.getTimestamp(),(double)1000);
