#ifndef DEVICEVECTORI64_H_
#define DEVICEVECTORI64_H_
 ...
 *          of type vector<int64_t> for testing purposes of nds-core V3.
 *
 *
...
public:
     ...
     */
    DeviceVectorI64(nds::Factory& factory, const std::string& deviceName, const nds::namedParameters_t& );
    ~DeviceVectorI64();
     ...
     *  the device
     */
    static DeviceVectorI64* getInstance(const std::string& deviceName);
...
private:
    ...
    /**
     * @brief DeviceVectorI64 state machine
     */
    nds::StateMachine m_DeviceVectorI64_stateMachine;

    /**
     * Methods to control DeviceVectorI64 state machine
     */
    void switchOn_DeviceVectorI64();  ///< Called to switch on the DeviceVectorI64 (rootnode).
    void switchOff_DeviceVectorI64(); ///< Called to switch off the DeviceVectorI64 (rootnode).
    void start_DeviceVectorI64();     ///< Called to start the DeviceVectorI64 (rootnode).
    void stop_DeviceVectorI64();      ///< Called to stop the DeviceVectorI64 (rootnode).
    void recover_DeviceVectorI64();   ///< Called to recover the DeviceVectorI64 (rootnode) from a failure.

    bool allow_DeviceVectorI64_Change(const nds::state_t, const nds::state_t, const nds::state_t); ///< Called to verify if a state change is allowed
     ...
     */
    nds::DataAcquisition<std::vector<std::int64_t> > m_DataAcquisition;
     ...
     */
    nds::WaveformGeneration<std::vector<std::int64_t>> m_WaveformGeneration;
